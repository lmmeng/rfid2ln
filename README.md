...
The Tx can be freely choosed among the Arduino pins, but the sketch defaults to the Pin 6. If you use another one, you should update the LN_TX_PIN definition in the sketch.
